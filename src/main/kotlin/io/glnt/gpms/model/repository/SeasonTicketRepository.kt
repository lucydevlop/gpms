...
//fun findByRangedValidTickets(vehicleNo: String, ticketType: TicketType, effectDate: LocalDateTime, expireDate: LocalDateTime) : List<ProductTicket>?
    ...
    fun findByTicketSnAndDelYnAndExtendYnAndEffectDateLessThanAndExpireDateGreaterThanAndTicketTypeAndNextSnIsNull(ticketSn: Long, delYn: DelYn, extendYn: Yn, date1: LocalDateTime, date2: LocalDateTime, ticketType: TicketType): List<SeasonTicket>?

    fun findByVehicleNoAndTicketTypeAndEffectDateBetweenAndDelYn(vehiclNo: String, ticketType: TicketType, date1: LocalDateTime, date2: LocalDateTime, delYn: DelYn): List<SeasonTicket>?
...
interface TicketClassRepository: JpaRepository<TicketClass, Long> {
    ...
    fun findByDelYnAndExtendYn(delYn: DelYn, extendYn: Yn?): List<TicketClass>?
}